defmodule AgentCore.WorkflowEngine.Spec do
  @moduledoc """
  ...
  ## Examples
      ...
      ...> }
      iex> AgentCore.WorkflowEngine.Spec.validate(spec)
      :ok

      iex> invalid_spec = %AgentCore.WorkflowEngine.Spec{id: :test}
      iex> AgentCore.WorkflowEngine.Spec.validate(invalid_spec)
  ...
  ## Examples
      ...
      iex> AgentCore.WorkflowEngine.Spec.new(
      ...>   id: :test,
      ...>   version: 1,
      ...>   entry: :start,
      ...>   exits: [:done],
      ...
      ...>   edges: [%{from: :start, to: :done, when: {:always}}]
      ...> )
      {:ok, %AgentCore.WorkflowEngine.Spec{...}}
  """
