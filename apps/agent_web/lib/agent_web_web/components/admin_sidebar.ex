defmodule AgentWebWeb.AdminSidebar do
  ...
  @navigation_sections %{
    ...
    operations: [
      ...
      %{
        key: :agent_testing,
        label: "RAG History Chat",
        href: "/admin/agent-testing",
  ...
  def update(assigns, socket) do
    ...
    {:ok,
     socket
     # Αυτό περιλαμβάνει το :collapsed από το parent
     |> assign(assigns)
  ...
  defp generate_breadcrumbs(current_page) do
    ...
    page_breadcrumb =
      case current_page do
        ...
        :agent_testing -> %{label: "RAG History Chat", path: "/admin/agent-testing"}
